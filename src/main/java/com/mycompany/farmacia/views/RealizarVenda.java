...
public class RealizarVenda extends JPanel {
    ...
    public RealizarVenda() {
        setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));  // BoxLayout em Y para alinhar os componentes na vertical
        setBorder(BorderFactory.createEmptyBorder(20, 20, 20, 20));  // Adiciona algum espaço ao redor do conteúdo
        ...
        txtCodigo.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(new Color(24, 39, 55), 1), 
            BorderFactory.createEmptyBorder(10, 10, 10, 10) // Espaço interno
        ));
        ...
        lblQuantidade.setBorder(BorderFactory.createEmptyBorder(20, 0, 10, 0)); // Espaçamento superior
        add(lblQuantidade);
        ...
        lblPrecoUnitario.setBorder(BorderFactory.createEmptyBorder(20, 0, 10, 0)); // Espaçamento superior
        ...
        lblDesconto.setBorder(BorderFactory.createEmptyBorder(20, 0, 10, 0)); // Espaçamento superior
        add(lblDesconto);
