<<<<<<< HEAD:src/main/java/views/Funcionario/EditarFuncionario.java
...
public class EditarFuncionario extends JPanel {
    ...
    private void carregarDadosFuncionario() {
        try (Connection conn = ConexaoBD.getConnection()) {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao carregar dados do funcionário: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
    }
...
>>>>>>> d1a3b99c77076cf6f95b6cb04968be10a9f31fea:src/main/java/com/mycompany/farmacia/views/EditarFuncionario.java
